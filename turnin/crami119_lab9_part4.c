 ...
 *	Create a concurrent sm with three different tasks, two with LEDs and one with speaker, speaker can now change frequency with buttons.
 *
 *
 *	I acknowledge all content contained herein, excluding template or example
 *	code, is my own original work.
 *
 *	Demo Link: Youtube URL> https://www.youtube.com/watch?v=4tZSpkULG08
 */
#include <avr/io.h>
...
//SM for controlling speaker frequency

enum FRQ_STATES{FRQ_Wait, FRQ_Incr, FRQ_Decr}FRQ_STATE;

void TickFct_FRQ(){

	switch(FRQ_STATE){ //state transitions for frequency states
	...
	switch(FRQ_STATE){ //state actions for frequency states
		case FRQ_Wait:
		case FRQ_Incr:
		case FRQ_Decr:
		default:
